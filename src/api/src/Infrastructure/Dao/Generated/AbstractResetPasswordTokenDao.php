...
/**
 * The AbstractResetPasswordTokenDao class will maintain the persistence of
 * ResetPasswordToken class into the reset_password_tokens table.
 */
abstract class AbstractResetPasswordTokenDao
{
    ...
    /**
     * Get a ResetPasswordToken filtered by accessToken.
     *
     * @param string $accessToken
     * @param string[] $additionalTablesFetch A list of additional tables to fetch (for performance improvement)
     * @return \App\Domain\Model\ResetPasswordToken|null
     */
    public function findOneByAccessToken(string $accessToken, array $additionalTablesFetch = []) : ?\App\Domain\Model\ResetPasswordToken
    {
        $filter = [
