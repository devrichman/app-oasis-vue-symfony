...
use App\Domain\Model\Generated\AbstractEventModel;
use TheCodingMachine\GraphQLite\Annotations\Type;

/**
 * The EventModel class maps the 'event_models' table in database.
 *
 * @Type
 */
class EventModel extends AbstractEventModel implements LoggableModel
{
    /**
